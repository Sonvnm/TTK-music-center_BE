...
{
    /// <inheritdoc />
    public partial class AddDB_00001 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorySystems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LearningProcessId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentStudyProcesses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningProcesses_UserId",
                table: "LearningProcesses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentStudyProcesses_LearningProcessId",
                table: "StudentStudyProcesses",
                column: "LearningProcessId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentStudyProcesses_UserId",
                table: "StudentStudyProcesses",
                column: "UserId");
